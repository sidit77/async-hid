// Copied from src/backend/hidraw/descriptor.rs sans the sysfs from_syspath
// method (FreeBSD gets the raw bytes via ioctl HIDIOCGRDESC instead).
// Follow-up: hoist into a shared module.
